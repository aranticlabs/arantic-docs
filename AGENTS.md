# AGENTS.md — AI Assistant Guide for arantic-docs

This file provides context, conventions, and workflows for AI assistants (Codex, Copilot, etc.) working in this repository.
...
- AI tools and integrations (Codex, GitHub Copilot, Cursor, Codex, Gemini CLI, Aider, Mistral)
- Codex deep-dives: memory, skills, subagents, agent teams, hooks, MCP, workflows, plugins
...
│   ├── Codex/             # Deep-dives: memory, skills, subagents, hooks, mcp, etc.
...
Explicitly permits major AI web crawlers including `Codex-Web`, `anthropic-ai`, `GPTBot`, `PerplexityBot`, and others. Do not remove these entries.
...
- **Do not commit code.** Codex should make file changes only; the user handles all commits and merges
