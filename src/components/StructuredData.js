...
export default function StructuredData() {
  const organization = {
    ...
    sameAs: ['https://github.com/aranticlabs'],
  };
  const webSite = {
    '@context': 'https://schema.org',
    '@type': 'WebSite',
    ...
    description:
      'Practical guides on using AI tools for programming — prompting, code generation, debugging, testing, Claude Code deep-dives, subagent blueprints, skill templates, and more.',
    publisher: {
      '@type': 'Organization',
      name: 'Arantic Digital',
    },
